...
public class ArrayListTest {
    ...
    public void shallowDeepCloneArrays() {
        ...
        clonedStudents = (ArrayList<Student>) students.clone();
        int[] clonedCopy;


        clonedCopy = new int[clonedStudents.size()];
        for (int i = 0; i < clonedCopy.length; i++) {
            clonedCopy[i] = clonedStudents.indexOf(i);
        }
